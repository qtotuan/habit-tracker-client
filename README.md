...
Open [https://sheltered-reef-37337.herokuapp.com](https://sheltered-reef-37337.herokuapp.com) to view it in the browser.
...
```json
{
  ...
  "configurations": [{
    ...
    "type": "chrome",
    "request": "launch",
    "url": "https://sheltered-reef-37337.herokuapp.com",
...
```
Fetch API cannot load http://localhost:4000/api/todos. No 'Access-Control-Allow-Origin' header is present on the requested resource. Origin 'https://sheltered-reef-37337.herokuapp.com' is therefore not allowed access. If an opaque response serves your needs, set the request's mode to 'no-cors' to fetch the resource with CORS disabled.
```
